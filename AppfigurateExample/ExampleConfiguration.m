...
STRING_PROPERTY_LIST(string_List, @"NSString - fixed list", NO, @{
    @"{PVT,DEV}Small":@"sm",
    @"Medium":@"md",
    @"{TEST}Large":@"lg"
});
STRING_PROPERTY_LIST_EDIT(string_Textfield_List, @"", @"NSString - textfield, customizable list", NO, @{
    @"{Dev}Red":@"r",
    @"Green":@"g",
    @"{pvt,TEST}Blue":@"b"
});
STRING_PROPERTY_LIST_EDIT(string_RegexTextfield_List, @"https://[\\w\\.-]+\\.electricbolt.co.nz/.*", @"NSString - textfield with regex, customizable list", NO, @{
...
INT_PROPERTY_LIST(integer_List, @"Integer - fixed list", NO, @{
    @"None":@-100,
    @"{DEV}Low":@-50,
    @"{PVT}Zero":@0,
    @"High":@50,
...
INT_PROPERTY_LIST_EDIT(integer_Textfield_List, 0, 100, @"", @"Integer - textfield, customizable list", NO, @{
    @"Failed":@0,
    @"Pass":@80,
    @"Excellence":@90
});
INT_PROPERTY_LIST_EDIT(integer_RegexTextfield_List, 0, 365, @"^(0?[0-9]?[0-9]|[1-2][0-9][0-9]|3[0-5][0-9]|36[0-5])$", @"Integer - textfield with regex, customizable list",NO, @{
    @"0 days":@0,
    @"1 month":@30,
    @"1 Year":@365
});
...
FLOAT_PROPERTY_LIST(float_List, @"Float - fixed list", NO, @{
    @"None":@-100.0,
    @"Low":@-50.0,
    @"Zero":@0.0,
    @"High":@50.0,
...
FLOAT_PROPERTY_LIST_EDIT(float_Textfield_List, 0.0, 100.0, @"", @"Float - textfield, customizable list", NO, @{
    @"Failed":@0.0,
    @"Pass":@80.0,
    @"Excellence":@90.0
});
FLOAT_PROPERTY_LIST_EDIT(float_RegexTextfield_List, 0.0, 366.0, @"^(0?[0-9]?[0-9]|[1-2][0-9][0-9]|3[0-5][0-9]|36[0-5])?(?:\\.\\d+)?$", @"Float - textfield with regex, customizable list", NO, @{
    @"0 days":@0.0,
    @"1 month":@30.0,
    @"1 Year":@365.0
});
...
DOUBLE_PROPERTY_LIST(double_List, @"Double - fixed list", YES, @{
    @"None":@-100.0,
    @"Low":@-50.0,
    @"Zero":@0.0,
    @"High":@50.0,
...
DOUBLE_PROPERTY_LIST_EDIT(double_Textfield_List, 0.0, 100.0, @"", @"Double - textfield, customizable list", NO, @{
    @"Failed":@0.0,
    @"Pass":@80.0,
    @"Excellence":@90.0
});
DOUBLE_PROPERTY_LIST_EDIT(double_RegexTextfield_List, 0.0, 366.0, @"^(0?[0-9]?[0-9]|[1-2][0-9][0-9]|3[0-5][0-9]|36[0-5])?(?:\\.\\d+)?$", @"Double - textfield with regex, customizable list", NO, @{
    @"0 days":@0.0,
    @"1 month":@30.0,
    @"1 Year":@365.0
});
